...
namespace IMS.UseCases.PluginInterfaces
{
    ...
    {
        Task<IEnumerable<ProductTransaction>> GetProductTransactionAsyn(string productName, DateTime? dateFrom, DateTime? dateTo, ProductTransactionType? transactionType);
